...
EMAIL_FROM = "sakshamjain.2008@gmail.com"
try:
    APP_PASSWORD = dbutils().secrets().get("finance-scope", "gmail_api_key")
...
def fraud_card_alert_stream():
    ...
    return spark.readStream.table("finance_ws.gold.fraud_card_alert")
